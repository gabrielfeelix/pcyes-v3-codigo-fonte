...
export function AuthModal() {
  ...
  const subtitle = success ? null : forgotPassword ? "Recuperar senha" : authModalTab === "login" ? "Bem-vindo de volta" : "Crie sua conta";
            ...
            >
              ...
              {success ? (
                ...
                <div role="status" className="px-8 pb-8 pt-2 text-center">
                  ...
                  {/* Mesmo título nos dois. "Revenda" seria palavra que a
                      pessoa nunca viu no fluxo, e "pessoa jurídica" só repete a
                      aba que ela acabou de clicar — a razão social logo abaixo
                      já diz que a conta é da empresa. */}
                  ...
                  <p className="pt-1 text-foreground/40" style={{ fontFamily: "var(--font-family-inter)", fontSize: "var(--text-caption)" }}>
                  ...
                  {authRedirect && (
                    <p className="pt-3 text-foreground/30" style={{ fontFamily: "var(--font-family-inter)", fontSize: "var(--text-caption)" }}>
